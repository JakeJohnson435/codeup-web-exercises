...
current.done(function(data) {
    console.log(data);
    $("#current").append("<p class='temp'>" + data.main.temp_max + "\xB0" + "/" + data.main.temp_min + "\xB0" + "</p>"
        ...
        + "<p><span class='pressure'>" + "Pressure: "  + "</span>" + data.main.pressure + "</p>");
    $("#city").text(data.name);
});
    ...
    response.list.forEach(function (forecast, i) {
        if (i > 0) {
            $("#forecast").append("<div class='forecast"+ i +"'><p class='temp'>" + forecast.temp.max + "\xB0" + "/"
                ...
                + "<p><span class='pressure'>" + "Pressure: "  + "</span>" + forecast.pressure + "</p>");
        }
        });
